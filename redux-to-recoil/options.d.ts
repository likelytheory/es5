...
declare const defaultOptions: Readonly<ReduxToRecoilOptions>;
/**
 ...
 */
declare const options: ReduxToRecoilOptions;
/**
 * Updates redux-to-recoil's global options.
 */
declare const setOptions: (newOptions: Partial<ReduxToRecoilOptions>) => ReduxToRecoilOptions;
